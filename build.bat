...
set COMMON_COMPILFER_FLAGS=-nologo -FeNova -MT -EHsc
set COMMON_LINKER_FLAGS=-incremental:no

set DEBUG_COMPILER_FLAGS=%COMMON_COMPILFER_FLAGS% -Zi
set RELEASE_COMPILER_FLAGS=%COMMON_COMPILFER_FLAGS% -O2 -Oi
